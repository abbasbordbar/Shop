        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImgCat = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubCatCategoryId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_subCategories", x => x.SubCategoryId);
                    table.ForeignKey(
                        name: "FK_subCategories_categories_ParentCategoryCategoryId",
                        column: x => x.ParentCategoryCategoryId,
                        principalTable: "categories",
                        principalColumn: "CategoryId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_subCategories_categories_SubCatCategoryId",
                        column: x => x.SubCatCategoryId,
                        principalTable: "categories",
                        principalColumn: "CategoryId",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CategoryAttributId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CategoryId = table.Column<int>(nullable: false),
                    ProductAttributeId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_categoryAttributs", x => x.CategoryAttributId);
                    table.ForeignKey(
                        name: "FK_categoryAttributs_categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "categories",
                        principalColumn: "CategoryId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_categoryAttributs_ProductAttributes_ProductAttributeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductImgId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProdoctImgName = table.Column<string>(nullable: false),
                    ProductId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductRatings_ProductAttributes_ProductAttributeId",
                        column: x => x.ProductAttributeId,
                        principalTable: "ProductAttributes",
                        principalColumn: "ProductAttributeId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_categoryAttributs_CategoryId",
                table: "categoryAttributs",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_categoryAttributs_ProductAttributeId",
                table: "categoryAttributs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductRatings_ProductAttributeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_subCategories_ParentCategoryCategoryId",
                table: "subCategories",
                column: "ParentCategoryCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_subCategories_SubCatCategoryId",
                table: "subCategories",
                column: "SubCatCategoryId");
        }
